    ...
    case SDL_KEYUP:
        {
            ...
            IM_VERIFY(key >= 0 && key < IM_ARRAYSIZE(io.KeysDown));
...
{
    ImGuiIO& io = ImGui::GetIO();
    IM_VERIFY(io.BackendPlatformUserData == NULL && "Already initialized a platform backend!");
...
void ImGui_ImplSDL2_NewFrame()
{
    ImGuiIO& io = ImGui::GetIO();
    ImGui_ImplSDL2_Data* bd = ImGui_ImplSDL2_GetBackendData();
    IM_VERIFY(bd != NULL && "Did you call ImGui_ImplSDL2_Init()?");
